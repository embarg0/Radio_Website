...
class TimeSlotsControllerTest < ActionController::TestCase
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post :create, time_slot: { endTime: @time_slot.endTime, playsheetNum: @time_slot.playsheetNum, showNum: @time_slot.showNum, startTime: @time_slot.startTime }
    end
  ...
  test "should update time_slot" do
    patch :update, id: @time_slot, time_slot: { endTime: @time_slot.endTime, playsheetNum: @time_slot.playsheetNum, showNum: @time_slot.showNum, startTime: @time_slot.startTime }
    assert_redirected_to time_slot_path(assigns(:time_slot))
  end
