...
class TimeslotsControllerTest < ActionController::TestCase
  ...
  test "should create timeslot" do
    assert_difference('Timeslot.count') do
      post :create, timeslot: { end_time: @timeslot.end_time, show_number: @timeslot.show_number, start_time: @timeslot.start_time }
    end
  ...
  test "should update timeslot" do
    patch :update, id: @timeslot, timeslot: { end_time: @timeslot.end_time, show_number: @timeslot.show_number, start_time: @timeslot.start_time }
    assert_redirected_to timeslot_path(assigns(:timeslot))
  end
