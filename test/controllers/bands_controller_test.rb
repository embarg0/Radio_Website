...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { name: @band.name, nationality: @band.nationality, stateYear: @band.stateYear }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { name: @band.name, nationality: @band.nationality, stateYear: @band.stateYear }
    assert_redirected_to band_path(assigns(:band))
  end
