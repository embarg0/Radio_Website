...
describe GuestsController do
  ...
  let(:valid_attributes) { { "last_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guest as @guest" do
        ...
        post :create, {:guest => { "last_name" => "invalid value" }}, valid_session
        assigns(:guest).should be_a_new(Guest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guest" do
        ...
        Guest.any_instance.should_receive(:update).with({ "last_name" => "MyString" })
        put :update, {:id => guest.to_param, :guest => { "last_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the guest as @guest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Guest.any_instance.stub(:save).and_return(false)
        put :update, {:id => guest.to_param, :guest => { "last_name" => "invalid value" }}, valid_session
        assigns(:guest).should eq(guest)
      end
